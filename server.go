...
import (
	"gowebappwithginaehtn/routers"
	"gowebappwithginaehtn/plugins"
...
func main() {
	...
	collector := plugins.InitializePrometheusCollector(plugins.PrometheusCollectorConfig{
		Namespace: "gowebappwithginaehtn",
	})
	...
	// tracer, closer := jaeger.NewTracer("gowebappwithginaehtn",
	// 	sampler,
	// 	reporter,
	...
	log.Info("Starting GoWebAppwithGinAEHTN on port " + port())
